...
class TestStorageDriver(tests_base.TestCase):
    ...
    def test_add_measures_big(self):
        ...
        self.assertEqual(3661, len(
            self.storage.get_aggregated_measures(m, aggregations)['mean']))
    ...
    def test_delete_old_measures(self):
        ...
        ]}, self.storage.get_aggregated_measures({self.metric: aggregations}))
    ...
    def test_rewrite_measures(self):
        ...
        ]}, self.storage.get_aggregated_measures({self.metric: [aggregation]}))
    ...
    def test_resize_policy(self):
        ...
        ]}, self.storage.get_aggregated_measures(m, [aggregation]))
