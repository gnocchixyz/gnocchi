...
RETRIEVE_RESOURCES_HISTORY = \
    "gnocchi.rest.aggregates.measures_grouper.Grouper." \
    "retrieve_resources_history"
API_AGGREGATE = \
...
class TestScenario(object):
    ...
    def __init__(self, mock_measure, mock_history, test_input,
        ...
        self.result = None
        self.grouper = measures_grouper.Grouper(test_input['test_group_by'],
...
def test_group_measures_changing_over_two_hours_with_more_than_one_resource():
    test_input = {
...
def test_group_measures_changing_over_two_hours():
    test_input = {
        'test_start': datetime.datetime(2020, 3, 10, 10, 0, 0, 0),
        'test_end': datetime.datetime(2020, 3, 10, 12, 0, 0, 0),
...
def test_group_measures_changing_flavors_in_a_hour():
    test_input = {
        'test_start': datetime.datetime(2020, 3, 10, 10, 0, 0, 0),
        'test_end': datetime.datetime(2020, 3, 10, 12, 0, 0, 0),
        'test_group_by': ['flavor_name'],
...
def test_group_measures_many_flavors_changes_in_a_hour():
    test_input = {
        'test_start': datetime.datetime(2020, 3, 10, 10, 0, 0, 0),
        'test_end': datetime.datetime(2020, 3, 10, 12, 0, 0, 0),
        'test_group_by': ['flavor_name'],
...
def test_group_measures_multiple_metadata_changed():
    test_input = {
        'test_start': datetime.datetime(2020, 3, 10, 10, 0, 0, 0),
        'test_end': datetime.datetime(2020, 3, 10, 12, 0, 0, 0),
