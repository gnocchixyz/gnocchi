...
from gnocchi.openstack.common import fileutils
from gnocchi.openstack.common.gettextutils import _, _LE, _LI
from gnocchi.openstack.common import log as logging
...
def main(argv):
    ...
    os.environ["GNOCCHI_LOCK_PATH"] = lock_dir
    try:
