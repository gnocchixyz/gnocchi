...
from gnocchi.openstack.common.db.sqlalchemy import utils
from gnocchi.openstack.common.gettextutils import _LE
...
def _set_db_lock(lock_path=None, lock_prefix=None):
    def decorator(f):
        ...
        def wrapper(*args, **kwargs):
            try:
                path = lock_path or os.environ.get("GNOCCHI_LOCK_PATH")
